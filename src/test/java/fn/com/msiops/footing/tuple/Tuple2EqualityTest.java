...
public class Tuple2EqualityTest {
    ...
    public void setup() {
        ...
        this.control = Tuple.of(this.v1, this.v2);
        this.equivalent = Tuple.of(this.v1, this.v2);

        this.diffs = new ArrayList<>();

        this.diffs.add(Tuple.of(new Object(), this.v2));
        this.diffs.add(Tuple.of(this.v1, new Object()));
