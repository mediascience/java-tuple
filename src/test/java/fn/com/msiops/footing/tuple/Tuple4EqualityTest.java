...
public class Tuple4EqualityTest {

    private Tuple4<?, ?, ?, ?> control, equivalent;

    private Collection<Tuple4<?, ?, ?, ?>> diffs;

    private Object v1, v2, v3, v4;
    ...
    public void setup() {
        ...
        this.control = Tuple.of(this.v1, this.v2, this.v3, this.v4);
        this.equivalent = Tuple.of(this.v1, this.v2, this.v3, this.v4);
